...
// Listener de malas palabras

const comment = document.getElementById("comment"); // El textarea

comment.addEventListener("input", sustituyeMalasPalabras); // Evento cada vez que introducimos/borramos carácter
